...
import meImg from "../assets/images/emma-sketch-pen.jpeg";
      ...
      <div className="col-start-2 col-span-7 md:col-start-3 md:col-span-5">
        ...
        <div className="flex justify-between align-center mt-xl">
          <div>
            ...
            <p className="mt-md">During the week I’m working on product at Fleet. Other days, I’m running on Mercer Island, playing Rocket League, and watching Arsenal FC.</p>
          </div>
          <div className="lg:flex lg:justify-end hidden">
            <img src={meImg} style={{maxWidth: "180px"}}className="object-cover h-auto ml-xl"></img>
          </div> 
        </div>
        <h3 className="mt-xl">WORK I'M PROUD OF</h3>
        <div className="flex justify-between items-start mt-lg flex-col lg:flex-row">
        ...
        <p className="mt-md">My proud gig. I can be doing a lot of things related to “product” on any given day.</p>
        <div className="flex justify-between items-start mt-lg flex-col lg:flex-row">
        ...
        <p className="mt-md">Dope team effort with Sam Nordale and Eric Kim. Working to achieve our music sharing vision.</p>
        <div className="flex justify-between items-start mt-lg flex-col lg:flex-row">
