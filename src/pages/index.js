  ...
  return (
    <Layout>
      ...
      <div className="col-start-3 col-span-5">
        ...
        <p className="mt-lg lg:w-1/2">Welcome to my site</p>
        <p className="mt-md lg:w-1/2">During the week I’m working on product at fleetdm.com and during the other days I’m running on Mercer Island, playing Rocket League, and watching Arsenal FC dissapoint.</p>
